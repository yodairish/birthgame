function Insta() {
  ...
  this._name = 'insta';
  this._quizText = 'Чтобы добыть следующее слово, тебе надо выполнить очень простое задание. Тут в стене имеется 6 нишь, все что тебе надо сделать это заполнить ими фотографиями. Для этого тебе надо выложить их в instagram и дернуть за этот рычаг и если к тому моменту будет все 6 фотографий, то стена откроется и ты сможешь забрать свое слово. Единственное фотографии должны быть свежие, за текущий день.';
